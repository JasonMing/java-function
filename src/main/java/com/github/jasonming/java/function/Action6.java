...
public interface Action6<P1, P2, P3, P4, P5, P6>
{
     ...
     * <p>
     * {@code map((Action6<P1, P2, P3, P4, P5, P6>) (p1, p2, p3, p4, p5, p6) -> foo()); }
     * <p>
     * 通过此方法，可简化为：
     * <p>
     ...
     * 执行此Action，并不返回任何值。
     */
    void invokeV(P1 p1, P2 p2, P3 p3, P4 p4, P5 p5, P6 p6);
     ...
     */
    default Action5<P2, P3, P4, P5, P6> apply(final P1 p1)
    {
     ...
     */
    default Action4<P3, P4, P5, P6> apply(final P1 p1, final P2 p2)
    {
     ...
     */
    default Action3<P4, P5, P6> apply(final P1 p1, final P2 p2, final P3 p3)
    {
     ...
     */
    default Action2<P5, P6> apply(final P1 p1, final P2 p2, final P3 p3, final P4 p4)
    {
     ...
     */
    default Action1<P6> apply(final P1 p1, final P2 p2, final P3 p3, final P4 p4, final P5 p5)
    {
     ...
     */
    default Action5<P1, P2, P3, P4, P5> applyR(final P6 p6)
    {
     ...
     */
    default Action4<P1, P2, P3, P4> applyR(final P5 p5, final P6 p6)
    {
     ...
     */
    default Action3<P1, P2, P3> applyR(final P4 p4, final P5 p5, final P6 p6)
    {
     ...
     */
    default Action2<P1, P2> applyR(final P3 p3, final P4 p4, final P5 p5, final P6 p6)
    {
     ...
     */
    default Action1<P1> applyR(final P2 p2, final P3 p3, final P4 p4, final P5 p5, final P6 p6)
    {
