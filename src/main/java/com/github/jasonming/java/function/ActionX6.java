...
/**
 * 提供一个6个参数，无返回值，声明抛出类型为{@link X}的函数式接口。
 */
@FunctionalInterface
public interface ActionX6<P1, P2, P3, P4, P5, P6, X extends Throwable>
        extends Action6<P1, P2, P3, P4, P5, P6>
{
    /**
     * 为lambda表达式提供简便的类型声明。
     * <p>
     ...
     * <p>
     * {@code map((ActionX6<P1, P2, P3, P4, P5, P6, X>) (p1, p2, p3, p4, p5, p6) -> foo()); }
     * <p>
     * 通过此方法，可简化为：
     * <p>
     * {@code map(ActionX6.of((p1, p2, p3, p4, p5, p6) -> foo())); }
     *
     * @param f 能适配ActionX6的lambda表达式或任意实例。
     *
     * @return {@code f}自身。
     */
    static <P1, P2, P3, P4, P5, P6, X extends Throwable> ActionX6<P1, P2, P3, P4, P5, P6, X> of(final ActionX6<P1, P2, P3, P4, P5, P6, X> f)
    {
        return f;
    }
     ...
     */
    @Override
    default <R> FuncX6<P1, P2, P3, P4, P5, P6, R, X> toFunc()
    {
     ...
     */
    @Override
    default <R> FuncX6<P1, P2, P3, P4, P5, P6, R, X> toFunc(final R returnValue)
    {
    ...
    {
        ((ActionX6<P1, P2, P3, P4, P5, P6, RuntimeException>)this).invokeVX(p1, p2, p3, p4, p5, p6);
    }

    /**
     * 执行此Action，并不返回任何值，期间可能会抛出类型为{@link X}的异常。
     */
    void invokeVX(P1 p1, P2 p2, P3 p3, P4 p4, P5 p5, P6 p6) throws X;
     ...
     */
    @Override
    default ActionX5<P2, P3, P4, P5, P6, X> apply(final P1 p1)
    {
     ...
     */
    @Override
    default ActionX4<P3, P4, P5, P6, X> apply(final P1 p1, final P2 p2)
    {
     ...
     */
    @Override
    default ActionX3<P4, P5, P6, X> apply(final P1 p1, final P2 p2, final P3 p3)
    {
     ...
     */
    @Override
    default ActionX2<P5, P6, X> apply(final P1 p1, final P2 p2, final P3 p3, final P4 p4)
    {
     ...
     */
    @Override
    default ActionX1<P6, X> apply(final P1 p1, final P2 p2, final P3 p3, final P4 p4, final P5 p5)
    {
     ...
     */
    @Override
    default ActionX5<P1, P2, P3, P4, P5, X> applyR(final P6 p6)
    {
     ...
     */
    @Override
    default ActionX4<P1, P2, P3, P4, X> applyR(final P5 p5, final P6 p6)
    {
     ...
     */
    @Override
    default ActionX3<P1, P2, P3, X> applyR(final P4 p4, final P5 p5, final P6 p6)
    {
     ...
     */
    @Override
    default ActionX2<P1, P2, X> applyR(final P3 p3, final P4 p4, final P5 p5, final P6 p6)
    {
     ...
     */
    @Override
    default ActionX1<P1, X> applyR(final P2 p2, final P3 p3, final P4 p4, final P5 p5, final P6 p6)
    {
