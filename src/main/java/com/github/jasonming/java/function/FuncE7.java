...
/**
 * 提供一个7个参数，返回值为{@link R}，声明抛出类型为{@link Exception}的函数式接口。
 */
@FunctionalInterface
        ...
        extends FuncX7<P1, P2, P3, P4, P5, P6, P7, R, Exception>, ActionE7<P1, P2, P3, P4, P5, P6, P7>
{
     ...
     * <p>
     * {@code map((FuncE7<P1, P2, P3, P4, P5, P6, P7, R>) (p1, p2, p3, p4, p5, p6, p7) -> foo()); }
     * <p>
     * 通过此方法，可简化为：
     * <p>
     ...
     */
    @Override
    default FuncE6<P2, P3, P4, P5, P6, P7, R> apply(final P1 p1)
    {
     ...
     */
    @Override
    default FuncE5<P3, P4, P5, P6, P7, R> apply(final P1 p1, final P2 p2)
    {
     ...
     */
    @Override
    default FuncE4<P4, P5, P6, P7, R> apply(final P1 p1, final P2 p2, final P3 p3)
    {
     ...
     */
    @Override
    default FuncE3<P5, P6, P7, R> apply(final P1 p1, final P2 p2, final P3 p3, final P4 p4)
    {
     ...
     */
    @Override
    default FuncE2<P6, P7, R> apply(final P1 p1, final P2 p2, final P3 p3, final P4 p4, final P5 p5)
    {
     ...
     */
    @Override
    default FuncE1<P7, R> apply(final P1 p1, final P2 p2, final P3 p3, final P4 p4, final P5 p5, final P6 p6)
    {
     ...
     */
    @Override
    default FuncE6<P1, P2, P3, P4, P5, P6, R> applyR(final P7 p7)
    {
     ...
     */
    @Override
    default FuncE5<P1, P2, P3, P4, P5, R> applyR(final P6 p6, final P7 p7)
    {
     ...
     */
    @Override
    default FuncE4<P1, P2, P3, P4, R> applyR(final P5 p5, final P6 p6, final P7 p7)
    {
     ...
     */
    @Override
    default FuncE3<P1, P2, P3, R> applyR(final P4 p4, final P5 p5, final P6 p6, final P7 p7)
    {
     ...
     */
    @Override
    default FuncE2<P1, P2, R> applyR(final P3 p3, final P4 p4, final P5 p5, final P6 p6, final P7 p7)
    {
     ...
     */
    @Override
    default FuncE1<P1, R> applyR(final P2 p2, final P3 p3, final P4 p4, final P5 p5, final P6 p6, final P7 p7)
    {
