...
public interface Action7<P1, P2, P3, P4, P5, P6, P7>
{
     ...
     * <p>
     * {@code map((Action7<P1, P2, P3, P4, P5, P6, P7>) (p1, p2, p3, p4, p5, p6, p7) -> foo()); }
     * <p>
     * 通过此方法，可简化为：
     * <p>
     * {@code map(Action7.of((p1, p2, p3, p4, p5, p6, p7) -> foo())); }
     *
     * @param f 能适配Action7的lambda表达式或任意实例。
     *
     * @return {@code f}自身。
     */
    static <P1, P2, P3, P4, P5, P6, P7> Action7<P1, P2, P3, P4, P5, P6, P7> of(final Action7<P1, P2, P3, P4, P5, P6, P7> f)
    {
        return f;
    }
     ...
     */
    default <R> Func7<P1, P2, P3, P4, P5, P6, P7, R> toFunc()
    {
     ...
     * @apiNote <code><b>void</b> invoke(p1, p2, p3, p4, p5, p6, p7)</code> &#8658; <code><b>R</b> invoke(p1, p2, p3, p4, p5, p6, p7)</code>
     */
    default <R> Func7<P1, P2, P3, P4, P5, P6, P7, R> toFunc(final R returnValue)
    {
     ...
     * 执行此Action，并不返回任何值。
     */
    void invokeV(P1 p1, P2 p2, P3 p3, P4 p4, P5 p5, P6 p6, P7 p7);
     ...
     */
    default Action6<P2, P3, P4, P5, P6, P7> apply(final P1 p1)
    {
     ...
     */
    default Action5<P3, P4, P5, P6, P7> apply(final P1 p1, final P2 p2)
    {
     ...
     */
    default Action4<P4, P5, P6, P7> apply(final P1 p1, final P2 p2, final P3 p3)
    {
     ...
     */
    default Action3<P5, P6, P7> apply(final P1 p1, final P2 p2, final P3 p3, final P4 p4)
    {
     ...
     */
    default Action2<P6, P7> apply(final P1 p1, final P2 p2, final P3 p3, final P4 p4, final P5 p5)
    {
     ...
     */
    default Action1<P7> apply(final P1 p1, final P2 p2, final P3 p3, final P4 p4, final P5 p5, final P6 p6)
    {
     ...
     */
    default Action6<P1, P2, P3, P4, P5, P6> applyR(final P7 p7)
    {
     ...
     */
    default Action5<P1, P2, P3, P4, P5> applyR(final P6 p6, final P7 p7)
    {
     ...
     */
    default Action4<P1, P2, P3, P4> applyR(final P5 p5, final P6 p6, final P7 p7)
    {
     ...
     */
    default Action3<P1, P2, P3> applyR(final P4 p4, final P5 p5, final P6 p6, final P7 p7)
    {
     ...
     */
    default Action2<P1, P2> applyR(final P3 p3, final P4 p4, final P5 p5, final P6 p6, final P7 p7)
    {
     ...
     */
    default Action1<P1> applyR(final P2 p2, final P3 p3, final P4 p4, final P5 p5, final P6 p6, final P7 p7)
    {
