...
/**
 * 提供一个5个参数，返回值为{@link R}，声明抛出类型为{@link X}的函数式接口。
 */
@FunctionalInterface
        ...
        extends Func5<P1, P2, P3, P4, P5, R>
{
     ...
     * <p>
     * {@code map((FuncX5<P1, P2, P3, P4, P5, R, X>) (p1, p2, p3, p4, p5) -> foo()); }
     * <p>
     * 通过此方法，可简化为：
     * <p>
    ...
    default R invoke(final P1 p1, final P2 p2, final P3 p3, final P4 p4, final P5 p5)
    {
        return ((FuncX5<P1, P2, P3, P4, P5, R, RuntimeException>)this).invokeX(p1, p2, p3, p4, p5);
    }
     ...
     */
    @Override
    default FuncX4<P2, P3, P4, P5, R, X> apply(final P1 p1)
    {
     ...
     */
    @Override
    default FuncX3<P3, P4, P5, R, X> apply(final P1 p1, final P2 p2)
    {
     ...
     */
    @Override
    default FuncX2<P4, P5, R, X> apply(final P1 p1, final P2 p2, final P3 p3)
    {
     ...
     */
    @Override
    default FuncX1<P5, R, X> apply(final P1 p1, final P2 p2, final P3 p3, final P4 p4)
    {
     ...
     */
    @Override
    default FuncX4<P1, P2, P3, P4, R, X> applyR(final P5 p5)
    {
     ...
     */
    @Override
    default FuncX3<P1, P2, P3, R, X> applyR(final P4 p4, final P5 p5)
    {
     ...
     */
    @Override
    default FuncX2<P1, P2, R, X> applyR(final P3 p3, final P4 p4, final P5 p5)
    {
     ...
     */
    @Override
    default FuncX1<P1, R, X> applyR(final P2 p2, final P3 p3, final P4 p4, final P5 p5)
    {
