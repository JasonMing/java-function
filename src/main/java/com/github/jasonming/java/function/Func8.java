...
/**
 * 提供一个8个参数，返回值为{@link R}，无异常抛出声明的函数式接口。
 */
@FunctionalInterface
public interface Func8<P1, P2, P3, P4, P5, P6, P7, P8, R>
{
     ...
     * <p>
     * {@code map((Func8<P1, P2, P3, P4, P5, P6, P7, P8, R>) (p1, p2, p3, p4, p5, p6, p7, p8) -> foo()); }
     * <p>
     * 通过此方法，可简化为：
     * <p>
     * {@code map(Func8.of((p1, p2, p3, p4, p5, p6, p7, p8) -> foo())); }
     *
     * @param f 能适配Func8的lambda表达式或任意实例。
     *
     * @return {@code f}自身。
     */
    static <P1, P2, P3, P4, P5, P6, P7, P8, R> Func8<P1, P2, P3, P4, P5, P6, P7, P8, R> of(final Func8<P1, P2, P3, P4, P5, P6, P7, P8, R> f)
    {
        return f;
    }
     ...
     *
     * @apiNote <code><b>R</b> invoke(p1, p2, p3, p4, p5, p6, p7, p8)</code> &#8658; <code><b>void</b> invoke(p1, p2, p3, p4, p5, p6, p7, p8)</code>
     */
    default Action8<P1, P2, P3, P4, P5, P6, P7, P8> asAction()
    {
        return this::invoke;
    }
     ...
     */
    default Func7<P2, P3, P4, P5, P6, P7, P8, R> apply(final P1 p1)
    {
     ...
     */
    default Func6<P3, P4, P5, P6, P7, P8, R> apply(final P1 p1, final P2 p2)
    {
     ...
     */
    default Func5<P4, P5, P6, P7, P8, R> apply(final P1 p1, final P2 p2, final P3 p3)
    {
     ...
     */
    default Func4<P5, P6, P7, P8, R> apply(final P1 p1, final P2 p2, final P3 p3, final P4 p4)
    {
     ...
     */
    default Func3<P6, P7, P8, R> apply(final P1 p1, final P2 p2, final P3 p3, final P4 p4, final P5 p5)
    {
     ...
     */
    default Func2<P7, P8, R> apply(final P1 p1, final P2 p2, final P3 p3, final P4 p4, final P5 p5, final P6 p6)
    {
     ...
     */
    default Func1<P8, R> apply(final P1 p1, final P2 p2, final P3 p3, final P4 p4, final P5 p5, final P6 p6, final P7 p7)
    {
     ...
     */
    default Func7<P1, P2, P3, P4, P5, P6, P7, R> applyR(final P8 p8)
    {
     ...
     */
    default Func6<P1, P2, P3, P4, P5, P6, R> applyR(final P7 p7, final P8 p8)
    {
     ...
     */
    default Func5<P1, P2, P3, P4, P5, R> applyR(final P6 p6, final P7 p7, final P8 p8)
    {
     ...
     */
    default Func4<P1, P2, P3, P4, R> applyR(final P5 p5, final P6 p6, final P7 p7, final P8 p8)
    {
     ...
     */
    default Func3<P1, P2, P3, R> applyR(final P4 p4, final P5 p5, final P6 p6, final P7 p7, final P8 p8)
    {
     ...
     */
    default Func2<P1, P2, R> applyR(final P3 p3, final P4 p4, final P5 p5, final P6 p6, final P7 p7, final P8 p8)
    {
     ...
     */
    default Func1<P1, R> applyR(final P2 p2, final P3 p3, final P4 p4, final P5 p5, final P6 p6, final P7 p7, final P8 p8)
    {
