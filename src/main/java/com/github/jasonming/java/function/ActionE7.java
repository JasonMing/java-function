...
/**
 * 提供一个7个参数，无返回值，声明抛出类型为{@link Exception}的函数式接口。
 */
@FunctionalInterface
public interface ActionE7<P1, P2, P3, P4, P5, P6, P7>
        extends ActionX7<P1, P2, P3, P4, P5, P6, P7, Exception>
{
    /**
     * 为lambda表达式提供简便的类型声明。
     * <p>
     ...
     * <p>
     * {@code map((ActionE7<P1, P2, P3, P4, P5, P6, P7>) (p1, p2, p3, p4, p5, p6, p7) -> foo()); }
     * <p>
     * 通过此方法，可简化为：
     * <p>
     * {@code map(ActionE7.of((p1, p2, p3, p4, p5, p6, p7) -> foo())); }
     *
     * @param f 能适配ActionE7的lambda表达式或任意实例。
     *
     * @return {@code f}自身。
     */
    static <P1, P2, P3, P4, P5, P6, P7> ActionE7<P1, P2, P3, P4, P5, P6, P7> of(final ActionE7<P1, P2, P3, P4, P5, P6, P7> f)
    {
        return f;
    }
     ...
     */
    @Override
    default ActionE6<P2, P3, P4, P5, P6, P7> apply(final P1 p1)
    {
     ...
     */
    @Override
    default ActionE5<P3, P4, P5, P6, P7> apply(final P1 p1, final P2 p2)
    {
     ...
     */
    @Override
    default ActionE4<P4, P5, P6, P7> apply(final P1 p1, final P2 p2, final P3 p3)
    {
     ...
     */
    @Override
    default ActionE3<P5, P6, P7> apply(final P1 p1, final P2 p2, final P3 p3, final P4 p4)
    {
     ...
     */
    @Override
    default ActionE2<P6, P7> apply(final P1 p1, final P2 p2, final P3 p3, final P4 p4, final P5 p5)
    {
     ...
     */
    @Override
    default ActionE1<P7> apply(final P1 p1, final P2 p2, final P3 p3, final P4 p4, final P5 p5, final P6 p6)
    {
     ...
     */
    @Override
    default ActionE6<P1, P2, P3, P4, P5, P6> applyR(final P7 p7)
    {
     ...
     */
    @Override
    default ActionE5<P1, P2, P3, P4, P5> applyR(final P6 p6, final P7 p7)
    {
     ...
     */
    @Override
    default ActionE4<P1, P2, P3, P4> applyR(final P5 p5, final P6 p6, final P7 p7)
    {
     ...
     */
    @Override
    default ActionE3<P1, P2, P3> applyR(final P4 p4, final P5 p5, final P6 p6, final P7 p7)
    {
     ...
     */
    @Override
    default ActionE2<P1, P2> applyR(final P3 p3, final P4 p4, final P5 p5, final P6 p6, final P7 p7)
    {
     ...
     */
    @Override
    default ActionE1<P1> applyR(final P2 p2, final P3 p3, final P4 p4, final P5 p5, final P6 p6, final P7 p7)
    {
     ...
     */
    @Override
    default <R> FuncE7<P1, P2, P3, P4, P5, P6, P7, R> toFunc()
    {
     ...
     */
    @Override
    default <R> FuncE7<P1, P2, P3, P4, P5, P6, P7, R> toFunc(final R returnValue)
    {
