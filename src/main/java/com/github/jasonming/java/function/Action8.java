...
public interface Action8<P1, P2, P3, P4, P5, P6, P7, P8>
{
     ...
     * <p>
     * {@code map((Action8<P1, P2, P3, P4, P5, P6, P7, P8>) (p1, p2, p3, p4, p5, p6, p7, p8) -> foo()); }
     * <p>
     * 通过此方法，可简化为：
     * <p>
     ...
     * 执行此Action，并不返回任何值。
     */
    void invokeV(P1 p1, P2 p2, P3 p3, P4 p4, P5 p5, P6 p6, P7 p7, P8 p8);
     ...
     */
    default Action7<P2, P3, P4, P5, P6, P7, P8> apply(final P1 p1)
    {
     ...
     */
    default Action6<P3, P4, P5, P6, P7, P8> apply(final P1 p1, final P2 p2)
    {
     ...
     */
    default Action5<P4, P5, P6, P7, P8> apply(final P1 p1, final P2 p2, final P3 p3)
    {
     ...
     */
    default Action4<P5, P6, P7, P8> apply(final P1 p1, final P2 p2, final P3 p3, final P4 p4)
    {
     ...
     */
    default Action3<P6, P7, P8> apply(final P1 p1, final P2 p2, final P3 p3, final P4 p4, final P5 p5)
    {
     ...
     */
    default Action2<P7, P8> apply(final P1 p1, final P2 p2, final P3 p3, final P4 p4, final P5 p5, final P6 p6)
    {
     ...
     */
    default Action1<P8> apply(final P1 p1, final P2 p2, final P3 p3, final P4 p4, final P5 p5, final P6 p6, final P7 p7)
    {
     ...
     */
    default Action7<P1, P2, P3, P4, P5, P6, P7> applyR(final P8 p8)
    {
     ...
     */
    default Action6<P1, P2, P3, P4, P5, P6> applyR(final P7 p7, final P8 p8)
    {
     ...
     */
    default Action5<P1, P2, P3, P4, P5> applyR(final P6 p6, final P7 p7, final P8 p8)
    {
     ...
     */
    default Action4<P1, P2, P3, P4> applyR(final P5 p5, final P6 p6, final P7 p7, final P8 p8)
    {
     ...
     */
    default Action3<P1, P2, P3> applyR(final P4 p4, final P5 p5, final P6 p6, final P7 p7, final P8 p8)
    {
     ...
     */
    default Action2<P1, P2> applyR(final P3 p3, final P4 p4, final P5 p5, final P6 p6, final P7 p7, final P8 p8)
    {
     ...
     */
    default Action1<P1> applyR(final P2 p2, final P3 p3, final P4 p4, final P5 p5, final P6 p6, final P7 p7, final P8 p8)
    {
